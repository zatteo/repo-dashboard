...
export function RepositoryListItem({ repository: repo }: RepositoryListItemProps) {
	return (
				...
				<div className="flex items-start gap-4 flex-1">
					...
					<div className="flex-1">
						...
						{repo.topics.length > 0 && (
							<div className="flex flex-wrap gap-2 mb-3" role="list" aria-label="Repository topics">
			...
			<div className="flex items-center gap-6 text-sm text-gray-400 pt-4 border-t border-slate-700">
				{repo.language && (
					<div className="flex items-center gap-2">
						<span className="w-3 h-3 bg-cyan-500 rounded-full" aria-hidden="true"></span>
